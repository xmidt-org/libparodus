...
application, document it in the [README](https://github.com/Comcast/libparodus/blob/master/README.md) or [wiki](https://github.com/Comcast/libparodus/wiki)! This includes new features, additional variants of behavior and breaking changes.
